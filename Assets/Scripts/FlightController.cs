...
public class FlightController : MonoBehaviour
{
	...
	public float UnitPerMeter = 1.0f;
	...
	void Update () {
		...
		float speedFactor = UnitCalculator.ToUnitFactorFromVelocity(KilometerPerHour, UnitPerMeter, MeterPerKilometer, SecondsPerHour);
